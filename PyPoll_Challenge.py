...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_results = (f"{county_name}: {voter_turnout_percentage:.1f}% ({voter_turnout})")
        ...
        if (voter_turnout > highest_votes) and (voter_turnout_percentage > highest_turnout_percentage):
            highest_votes = voter_turnout
            highest_turnout_percentage = voter_turnout_percentage
